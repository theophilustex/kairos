...
683 tests, all standard-library `unittest`. There is no framework to install
...
| `test_sync_token.py` | Change-tokens, and not stranding a calendar empty. |
| `test_slot_and_reminders.py` | Two-click slot picking, and calendar-wide reminders. |
